jQuery(function(){
	...
	*/
	...
	jQuery('#cfg-contactform-3 .cfg-uploadfilename').val(''); // FF may keep the file name in the cfg-uploadfilename input after submitting and refreshing the page
	
	jQuery('#cfg-contactform-3 .cfg-captcha-refresh').click(function(){
		
		jQuery('#cfg-contactform-3 .cfg-captcha-img').attr('src','cfg-contactform-3/inc/captcha.php?r='+Math.random());
	});
	
	jQuery('#cfg-contactform-3 .cfg-submit').click(function(){
		...
		jQuery.post('cfg-contactform-3/inc/form-validation.php',
				{ 
	...
	jQuery('body').on('click', '#cfg-contactform-3 .cfg-deleteupload', function()
	{
